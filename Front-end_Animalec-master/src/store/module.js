...
import {
  ...
  // Mutations
  SET_MESSAGE,
  SET_USERS // Incluindo SET_USERS para evitar avisos
} from "./constants";

const state = {
  message: "",
  users: [], // Adicionando uma lista para armazenar usuários
  userLevels: [
...
const getters = {
  ...
  getUsers: state => state.users // Getter para obter a lista de usuários
};
...
export const mutations = {
  ...
  [SET_USERS]: (state, users) => {
    state.users = users; // Mutação para atualizar a lista de usuários
  }
};
